...
const Search = () => {
    ...
    return (
        <div className='w-full lg:min-w-[420px] h-11 lg:h-12 rounded-lg border overflow-hidden flex items-center text-neutral-500 bg-slate-50 group focus-within:border-green-500'>
            <div>
