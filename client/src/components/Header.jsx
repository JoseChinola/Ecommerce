...
const Header = ({ toggleAside }) => {
    ...
    const isHidden = location.pathname === "/login" || location.pathname === "/register" || location.pathname === "/forgot-password" || location.pathname === "/verification-otp" || location.pathname === "/reset-password" || location.pathname === "/verify-email" || location.pathname === "/verify-email-register";
                    ...
                    <div className='container mx-auto flex items-center justify-between'>
                        ...
                        <div className='h-full'>
                            <Link to={"/"} className='h-full flex items-center gap-3 ml-4'>
                                ...
                                <h2 className='text-md select-none lg:italic lg:text-lg lg:flex flex-col lg:text-left text-primary-Green text-center uppercase font-extrabold'>
                                    D’RAF SERVICES
                                    <span className='hidden xl:block text-sm italic font-medium animate-bounce'>
